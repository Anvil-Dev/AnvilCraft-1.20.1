...
public class EmberMetalUpgradeTemplateItem extends SmithingTemplateItem {
    ...
    private static final Component APPLIES_TO =
        Component.translatable("screen.anvilcraft.smithing_template.ember_metal_upgrade_smithing_template.applies_to")
    ...
    private static final Component UPGRADE =
        Component.translatable("screen.anvilcraft.ember_metal_upgrade_smithing_template").withStyle(TITLE_FORMAT);
